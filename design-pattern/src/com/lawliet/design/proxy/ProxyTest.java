...
import com.lawliet.design.proxy.cglib.CglibDogEatProxy;
...
//        proxy.eat();
        ...
        // jdk动态代理
//        JdkDogEatProxy jdkDogEatProxy = new JdkDogEatProxy();
...
//        EatSubject eatSubject = (EatSubject) jdkDogEatProxy.newProxy(new DogEatSubject());
//        eatSubject.eat();
